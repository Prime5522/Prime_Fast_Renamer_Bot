	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/PRIME_BOTZ")],
                                      [InlineKeyboardButton("🦋 Admin Support 🦋", url="https://t.me/Prime_Bots_Support_RoBot")],
                                      [InlineKeyboardButton("🔎Movie Request Group🔍", url='https://t.me/Prime_Movies4U/143'),
                                      InlineKeyboardButton("✨ Movie Channel ✨", url='https://t.me/Prime_Movies4U')],
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://envs.sh/0lv.jpg')]
                                      ]))
        return
    if id:
        if old == True:
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact PrimeDeveloper 🦋", url='https://telegram.me/Prime_Nayem')],
                                                                     [InlineKeyboardButton("🔺 Admin Support 🔺", url='https://t.me/Prime_Bots_Support_RoBot')],
                                                                     [InlineKeyboardButton("🔥 Visit Channel 🔥", url='https://t.me/PRIME_BOTZ'),
                                                                     InlineKeyboardButton("✨ Visit Movie Channel ✨", url='https://t.me/Prime_Movies4U')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://envs.sh/0lv.jpg')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
        return 
        ...
        if value < file.file_size:
            ...
            if STRING:
                ...
                if pre_check == True:
                    ...
                    uploadlimit(message.from_user.id, 3221225472)
